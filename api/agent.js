...
ALWAYS start by searching the curated entity investigation database using search_entity_investigations. This is your highest-value data source — it contains 3,800+ pre-researched entities across 9 major investigations that standard screening completely misses. If the subject appears here, you have deep intelligence on their full network before you even start live screening.
...
- **search_entity_investigations**: ALWAYS USE FIRST. Curated database of 3,800+ pre-researched entities across 9 investigations. If the subject appears here, you have deep intelligence before live screening even starts. Contains full network maps for Russian oligarchs, Glencore, commodities sanctions, criminal enforcement, 70-subject database, SDN Top 100, SDN Batch 2 (Abramovich, Vekselberg, Kostin, Prigozhin, Gazprombank, Jho Low/1MDB, CZ/Binance), SDN Batch 3 (Lavrov, Evraz, LockBit, Evil Corp, Shadow Fleet, Kolomoisky, Hezbollah/Hamas/Houthi, Isabel dos Santos, Karimova, Firtash, Manafort), and SDN Batch 4 (Rashnikov/MMK, Chemezov/Rostec, Timchenko/Gunvor, Rotenberg, Melnichenko/EuroChem, Fridman/Alfa, Gazprom Neft/NIS Serbia, Sandworm, APT29, IRGC Charming Kitten, Hemedti/Sudan, Myanmar, Venezuela, Cuba, Belarus, Tornado Cash delisted, Bybit $1.5B, DPRK IT workers, NIOC ghost tankers, Wagner Africa Corps, CJNG fentanyl, Rosneft/Nayara, professional enablers, SWIFT/SPFS alternatives).
