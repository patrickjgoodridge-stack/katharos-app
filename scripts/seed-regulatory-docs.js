...
/**
 * Seed Katharos knowledge base into Pinecone RAG.
...
const SANCTIONS_CHUNKS = [
  {
    ...
    metadata: { source: 'Katharos KB', category: 'sanctions', title: 'OFAC SDN List' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'sanctions', title: '50 Percent Rule' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'sanctions', title: 'Match Confidence Levels' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'sanctions', title: 'Global Sanctions Lists' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'sanctions', title: 'High-Risk Jurisdictions' }
  },
];
...
const AML_CHUNKS = [
  {
    ...
    metadata: { source: 'Katharos KB', category: 'aml', title: 'ML Three Stages' }
  },
  {
    id: 'aml-structuring',
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'structuring', title: 'Structuring/Smurfing' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'cash_business', title: 'Cash-Intensive Business Laundering' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'shell_company', title: 'Shell Company Layering' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'layered_ownership', title: 'Layered Ownership' }
  },
  {
    id: 'aml-tbml',
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'tbml', title: 'Trade-Based Money Laundering' }
  },
  {
    id: 'aml-real-estate',
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'real_estate', title: 'Real Estate ML' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'correspondent_banking', title: 'Correspondent Banking Abuse' }
  },
  {
    id: 'aml-hawala-msb',
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'hawala', title: 'Hawala/IVTS' }
  },
  {
    id: 'aml-crypto',
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'crypto', title: 'Crypto ML Patterns' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'corruption', title: 'Corruption & PEP' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'sanctions_evasion', title: 'Sanctions Evasion Methods' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'aml', typology: 'terrorism_financing', title: 'Terrorism Financing' }
  },
];
...
const FRAUD_CHUNKS = [
  {
    ...
    metadata: { source: 'Katharos KB', category: 'fraud', typology: 'financial_statement', title: 'Financial Statement Fraud' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'fraud', typology: 'asset_misappropriation', title: 'Asset Misappropriation' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'fraud', typology: 'corruption', title: 'Corruption & Bribery Fraud' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'fraud', typology: 'banking', title: 'Banking & Lending Fraud' }
  },
  {
    id: 'fraud-insurance',
    ...
    metadata: { source: 'Katharos KB', category: 'fraud', typology: 'insurance', title: 'Insurance Fraud' }
  },
  {
    id: 'fraud-securities',
    ...
    metadata: { source: 'Katharos KB', category: 'fraud', typology: 'securities', title: 'Securities Fraud' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'fraud', typology: 'procurement', title: 'Procurement Fraud' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'fraud', typology: 'identity_cyber', title: 'Identity & Cyber Fraud' }
  },
  {
    id: 'fraud-crypto',
    ...
    metadata: { source: 'Katharos KB', category: 'fraud', typology: 'crypto_fraud', title: 'Cryptocurrency Fraud' }
  },
];
...
const RISK_SCORING_CHUNKS = [
  {
    ...
    metadata: { source: 'Katharos KB', category: 'risk_scoring', title: 'Sanctions Scoring' }
  },
  {
    id: 'risk-pep-scoring',
    ...
    metadata: { source: 'Katharos KB', category: 'risk_scoring', title: 'PEP Scoring' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'risk_scoring', title: 'Criminal/Enforcement Scoring' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'risk_scoring', title: 'Corporate Structure Scoring' }
  },
  {
    id: 'risk-aggregation',
    ...
    metadata: { source: 'Katharos KB', category: 'risk_scoring', title: 'Score Aggregation Rules' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'risk_scoring', title: 'Crypto Risk Scoring' }
  },
];
...
const TM_CHUNKS = [
  {
    ...
    metadata: { source: 'Katharos KB', category: 'transaction_monitoring', title: 'Structuring Rules' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'transaction_monitoring', title: 'Velocity Rules' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'transaction_monitoring', title: 'Geographic Rules' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'transaction_monitoring', title: 'Counterparty Rules' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'transaction_monitoring', title: 'Behavioral Rules' }
  },
  {
    id: 'tm-crypto-rules',
    ...
    metadata: { source: 'Katharos KB', category: 'transaction_monitoring', title: 'Crypto Detection Rules' }
  },
  {
    id: 'tm-network-rules',
    ...
    metadata: { source: 'Katharos KB', category: 'transaction_monitoring', title: 'Network Analysis Rules' }
  },
];
...
const DATA_SOURCE_CHUNKS = [
  {
    ...
    metadata: { source: 'Katharos KB', category: 'data_sources', title: 'Sanctions APIs' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'data_sources', title: 'Corporate Registries' }
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'data_sources', title: 'Leaked Databases' }
  },
  {
    id: 'ds-court-media',
    ...
    metadata: { source: 'Katharos KB', category: 'data_sources', title: 'Court Records & Media' }
  },
  {
    id: 'ds-crypto-pep',
    ...
    metadata: { source: 'Katharos KB', category: 'data_sources', title: 'Crypto & PEP Sources' }
  },
];
...
const METHODOLOGY_CHUNKS = [
  ...
  },
  {
    ...
    metadata: { source: 'Katharos KB', category: 'methodology', title: 'Risk Levels & Recommendations' }
  },
];
