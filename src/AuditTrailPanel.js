...
import { Shield, Filter, ChevronDown, Clock, User, Search } from 'lucide-react';
...
const AuditTrailPanel = () => {
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      {showFilters && (
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '10px', padding: '14px', background: '#f8f9fa', borderRadius: '8px', marginBottom: '16px' }}>
          <div>
      ...
      {loading && <div style={{ textAlign: 'center', padding: '20px', color: '#999' }}>Loading...</div>}
